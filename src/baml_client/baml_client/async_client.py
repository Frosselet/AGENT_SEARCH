...
class BamlStreamClient:
    ...
    def AnalyzePipeline(
        ...
        code: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.PipelineAnalysis, types.PipelineAnalysis]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.PipelineAnalysis, types.PipelineAnalysis](
        raw,
    ...
    def TransformPipeline(
        ...
        code: str,target_platform: str,analysis_context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.PipelineTransformation, types.PipelineTransformation]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.PipelineTransformation, types.PipelineTransformation](
        raw,
