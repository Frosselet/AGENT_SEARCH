...
PERFORMANCE_GOALS = {
    ...
    "future_scaling": {"max_pages": 2000, "timeline": "6 months"},
    "cost": {
        "monthly_budget": 500,
        "optimization_priority": "balanced",  # balanced, performance, cost
    },
    "availability": {"target_uptime": 99.5, "max_recovery_minutes": 5},
}
...
async def run_multi_agent_demo():
    ...
    print(
        f"  • Performance Target: {PERFORMANCE_GOALS['target_runtime_minutes']} minutes"
    )
    print(
        f"  • Current Runtime: {PERFORMANCE_GOALS['current_runtime_minutes']} minutes"
    )
    print()
    ...
    try:
        ...
        print(
            "   2. Architecture Optimization → AWS Service Selection + Splitter Analysis"
        )
